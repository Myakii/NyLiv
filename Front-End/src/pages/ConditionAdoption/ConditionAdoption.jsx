      ...
      <header>
        <div className="catch-phrase flex flex-col text-center gap-12">
          ...
          <div className="mid-part">
            ...
            <a
              href="https://www.la-spa.fr/adopter/sinformer-sur-ladoption/conditions-dadoption/le-certificat-dengagement-et-de-connaissance-des-besoins-specifiques-de-lespece/"
              className="text-[#E6610F]"
            >
              UN CERTIFICAT D’ENGAGEMENT ET DE CONNAISSANCE DES BESOINS
              SPÉCIFIQUES DE L’ESPÈCE.
            </a>
          </div>

          <button className="btn btn-orange bottom-part">
            <Link to="/listedesanimaux">J'adopte !</Link>
          </button>
        </div>

        <img
          src="../Assets/DesignImg/ConditionAdoptDog.png"
          className="pl-20 condition-dog"
        />
      </header>
